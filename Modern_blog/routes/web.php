...
Route::prefix('articles')->group(function() {
    ...
    Route::post('massdeleteAjax', 'App\Http\Controllers\ArticleController@massdestroyAjax')->name('article.massdestroyAjax'); 
...
Route::prefix('types')->group(function() {
    ...
    Route::post('massdeleteAjax', 'App\Http\Controllers\TypeController@massdestroyAjax')->name('type.massdestroyAjax');
